    ...
    <div className="flex flex-col gap-4 px-4  ">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-4">
        <div className="relative w-full lg:w-auto">
          ...
          />
          <div className="absolute md:bottom-6 bottom-4 left-6 md:left-10 bg-white p-4 rounded-lg md:max-w-[250px] max-w-[200px] shadow-lg">
            <h2 className="text-sm md:text-3xl font-medium text-black tracking-tighter
            ">Wood</h2>
        ...
        <div className="flex flex-col gap-4 w-full lg:w-auto">
          <div className="flex flex-col md:flex-row gap-4 justify-between">
            ...
            <div className="bg-black p-6 rounded-lg w-full md:w-auto md:flex-1 flex flex-col justify-between items-start">
              <div>
                <h2 className="md:text-3xl text-m font-medium text-white tracking-tighter">Dark</h2>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between">
            <div className="bg-black p-6 rounded-lg w-full md:w-auto md:flex-1 order-2 md:order-1 flex flex-col justify-between items-start">
              <div>
                <h2 className="md:text-3xl text-m font-medium text-white tracking-tighter">
                  Light
                </h2>
                <p className="mt-4 text-gray-400 text-base tracking-tight leading-tight">
